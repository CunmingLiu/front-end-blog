...
export const INSTAGRAM: string[] = [
  'https://img-blog.csdnimg.cn/ffb2694e6e414981aef60afbd7b88c21.png#pic_center',
  'https://img-blog.csdnimg.cn/ffb2694e6e414981aef60afbd7b88c21.png#pic_center',
  'https://img-blog.csdnimg.cn/ffb2694e6e414981aef60afbd7b88c21.png#pic_center',
  'https://img-blog.csdnimg.cn/ffb2694e6e414981aef60afbd7b88c21.png#pic_center',
  'https://img-blog.csdnimg.cn/ffb2694e6e414981aef60afbd7b88c21.png#pic_center',
...
export const AboutBlog: AboutBlogType[] = [
  ...
  { date: '📅2020/06/02', content: '博客,后台页面首屏优化' },
  {
    date: '📅2020/06/03',
    content:
      '由于静态资源托管cdn, 文章封面的上传与修改功能从本地存储改为cdn存储',
  },
  { date: '📅2020/06/04', content: '重构了博客UI' },
  {
    date: '📅2020/06/06',
    content: '用户系统完成用户登录注册前后端数据库联调完毕',
  },
  {
    date: '📅2020/06/06',
    content: 'Oauth前后端数据库联调完毕, 已支持github第三方登录',
  },
  {
    date: '📅2020/06/07',
    content: '留言板前后数据库联调完毕, 响应式done, 后台系统支持用户库浏览',
  },
  {
    date: '📅2020/06/07',
    content:
      '响应式小屏不显示sidebar, 新增按钮抽屉弹出sidebar, 新增文章阅读量展示',
  },
  {
    date: '📅2020/06/08',
    content: '留言板表逻辑问题修复, 文章与留言板都可回复',
  },
  {
    date: '📅2020/06/09',
    content: 'react-lazyload懒加载图片, 文章列表改为时间轴形式的归档',
  },
  {
    date: '📅2020/06/10',
    content:
      'tags标签已联调, 展示文章有哪些类别有多少篇, 点击跳转文章分类列表页. 优化一些问题',
  },
  { date: '📅2020/06/13', content: '前端blog代码已用typescript重构.' },
  {
    date: '📅2020/06/14',
    content: '前端管理系统代码已用typescript重构, 重构留言组件',
  },
];
